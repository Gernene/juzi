---
layout: post
title:  "History of the Story: Sun Slayer & Once Immortal"
date:   2026-04-22 00:00:00 -0000
permalink: /history-sun-slayer-once-immortal/
categories: [blog]
excerpt: Curious about the work which goes into writing eastern fantasy novels? I break down the history behind Sun Slayer and Once Immortal to give you a sneak peek at my process.
---
# History of the Story: Sun Slayer & Once Immortal

<div style="display: flex; justify-content: center;">
    <a href="{{ site.url }}/sun-slayer/">
        <img src="{{ site.url }}/img/writing/sun-slayer/sun-slayer-cover.jpg" title="Sun Slayer" alt="Sun Slayer" style="max-width: 200px; margin: 0 1rem 0 0;">
    </a>
    <a href="{{ site.url }}/once-immortal/">
        <img src="{{ site.url }}/img/writing/once-immortal/once-immortal-cover.jpg" title="Once Immortal" alt="Once Immortal" style="max-width: 200px">
    </a>
</div>
...
### Draft 4 (2020)
This is the draft I sent to my first round of beta readers (S, M, and B).
Did you know that the final version of Sun Slayer ends on the same line as this draft? It was one of the few elements of Sun Slayer which remained unchanged ever since.
